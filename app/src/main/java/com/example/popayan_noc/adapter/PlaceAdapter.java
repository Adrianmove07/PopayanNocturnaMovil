...
public class PlaceAdapter extends RecyclerView.Adapter<PlaceAdapter.PlaceViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PlaceViewHolder holder, int position) {
        ...
        if (place.getFotosLugar() != null && !place.getFotosLugar().isEmpty()) {
            ...
            holder.ivGalleryIcon.setOnClickListener(v -> {
                ...
                if (context instanceof androidx.fragment.app.FragmentActivity) {
                    ...
                    ImageGalleryDialogFragment dialog = ImageGalleryDialogFragment.newInstance(new java.util.ArrayList<>(place.getFotosLugar()));
        ...
        holder.cardView.setOnClickListener(v -> {
            androidx.fragment.app.Fragment fragment = new PlaceDetailFragment();
